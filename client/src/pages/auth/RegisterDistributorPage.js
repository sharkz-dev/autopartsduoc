...
const RegisterDistributorPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Set role to distributor
      registerData.role = 'distributor';
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            <p className="text-xs text-gray-500">
              Al registrarte como distribuidor, aceptas nuestros{' '}
<button
  type="button"
  className="text-blue-600 hover:text-blue-500"
  onClick={() => console.log('Términos y condiciones pendientes')}
>
...
<button
  type="button"
  className="text-blue-600 hover:text-blue-500"
  onClick={() => console.log('Política de privacidad pendiente')}
>
  Política de Privacidad
          ...
          <div>
            ...
            >
              ...
              {loading ? 'Procesando...' : 'Registrarse como Distribuidor'}
            </button>
          </div>
        </form>
      </div>
