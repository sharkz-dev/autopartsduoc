    ...
    <div>
          ...
          <div className="flex-grow">
            ...
            <div className="relative">
              <input
                ...
                className="block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm pl-10"
              />
      ...
      {currentProducts.length > 0 ? (
                ...
                <div>
                  <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                    ...
                    {[...Array(totalPages)].map((_, index) => {
                      ...
                      // Mostrar solo páginas cercanas a la actual y primera/última
                      const shouldShow = 
                        pageNumber === 1 || 
                      ...
                      if (!shouldShow) {
                        // Mostrar puntos suspensivos solo una vez para cada rango
                        if (
                        ...
                        // No mostrar páginas fuera del rango
                        return null;
                      }
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          <p className="text-gray-500 mb-4">No tienes productos registrados.</p>
          <Link
            to="/distributor/product/add"
