...
process.env.JWT_SECRET = 'test_jwt_secret_key_for_testing_123456789';
...
process.env.TRANSBANK_COMMERCE_CODE = 'test_commerce_code_123';
process.env.TRANSBANK_API_KEY = 'test_api_key_123';
